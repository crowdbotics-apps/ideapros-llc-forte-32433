...
## Project Structure
    ...
    ├── ideapros_llc_forte_32433  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_forte_32433`
...
2. Clone this repo and `cd ideapros_llc_forte_32433`
